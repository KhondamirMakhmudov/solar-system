...
const Index = () => {
  const gauges = [
    ...
    { name: "Temperature - 10sec", value: 56.39, min: 0, max: 500, unit: "°C" },
    { name: "Velocity - 10sec", value: 5.22, min: 0, max: 30, unit: "m/s" },
  ...
  return (
    <DashboardLayout headerTitle={"Ташкентская ТЭЦ"}>
